...
config :ushorten, UshortenWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "uPf11nvZhor5w7XtyFHecAqgvIBjFIxhZWlD0pSmgZVR63ffWzmOFFWaradThK5e",
  watchers: [
...
config :ushorten, UshortenWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ushorten_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ushorten, dev_routes: true

config :ushorten, :google_client, GoogleClient
